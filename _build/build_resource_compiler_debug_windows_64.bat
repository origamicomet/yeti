...
link.exe /nologo /machine:X64 /DEBUG /stack:0x400000,0x400000 ^
         /out:_build\bin\resource_compiler_debug_windows_64.exe ^
         _build\obj\resource_compiler_debug_windows_64.obj ^
...
echo Built `resource_compiler_debug_windows_64.exe`.
