...
namespace butane {
    ...
    bool fullscreen )
  {
    ...
    win32::Window* window =
      make_new(win32::Window, butane::Window::allocator())(title, width, height, fullscreen);
    ...
    win32::state_to_styles(fullscreen, styles, ex_styles);
    ...
    if (!hwnd) {
      make_delete(Window, butane::Window::allocator(), window);
      return nullptr; }
