//===-- yeti/application/time_step_policy.h -------------*- mode: C++11 -*-===//
//
//                             __ __     _   _
//                            |  |  |___| |_|_|
//                            |_   _| -_|  _| |
...
#ifndef _YETI_APPLICATION_TIME_STEP_POLICY_H_
#define _YETI_APPLICATION_TIME_STEP_POLICY_H_

#include "yeti/core.h"

namespace yeti {

/// \brief Common interface that encapsulates strategies for converting wall
/// and frame time into steps with corresponding deltas.
class YETI_PUBLIC TimeStepPolicy {
 ...
 public:
  ...
  void update(const core::Timer &frame,
...
#endif // _YETI_APPLICATION_TIME_STEP_POLICY_H_
