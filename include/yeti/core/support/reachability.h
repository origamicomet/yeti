//===-- yeti/core/support/reachability.h ----------------*- mode: C++11 -*-===//
//
//                 _____               _     _   _
...
#ifndef _YETI_CORE_SUPPORT_REACHABILITY_H_
#define _YETI_CORE_SUPPORT_REACHABILITY_H_
...
/// \brief Code is unreachable.
  ...
  #define YETI_UNREACHABLE()
    ...
    #define YETI_UNREACHABLE() __builtin_unreachable()
      ...
      #include <signal.h>
      #define YETI_UNREACHABLE() \
        do { ::signal(SIGTRAP); } while(0, 0)
    #endif
  #endif
#endif

#endif // _YETI_CORE_SUPPORT_REACHABILITY_H_
