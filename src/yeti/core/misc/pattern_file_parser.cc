//===-- yeti/core/misc/pattern_file_parser.cc -----------*- mode: C++11 -*-===//
//
//                 _____               _     _   _
...
PatternFileParser::PatternFileParser(File *file)
  : buffer_(core::global_heap_allocator())
{
...
const char *PatternFileParser::extract() {
  ...
  char *line = (char *)core::global_heap_allocator().allocate(length + 1);
